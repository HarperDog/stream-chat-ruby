...
module StreamChat
  ...
  class Client
    ...
    def commit_message(message_id); end
    ...
    def query_campaigns(**params); end
    ...
    def schedule_campaign(campaign_id, scheduled_for); end
    ...
    sig { params(params: T.untyped).returns(StreamChat::StreamResponse) }
    def query_recipients(**params); end
